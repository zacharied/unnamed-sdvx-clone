...
public:
	...
	void AddTexture(unique_ptr<ITexture>& out, const String& path);
	// Add a mesh to be loaded
	void AddMesh(unique_ptr<IMesh>& out, const String& path);
	// Add a mesh to be loaded
	void AddMaterial(unique_ptr<IMaterial>& out, const String& path);
