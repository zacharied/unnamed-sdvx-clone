...
#undef LoadImage
#endif
	unique_ptr<Image> LoadImage(const String& name);
	unique_ptr<Image> LoadImageExternal(const String & name);
	unique_ptr<Texture> LoadTexture(const String& name);
	unique_ptr<Texture> LoadTexture(const String & name, const bool& external);
	unique_ptr<Material> LoadMaterial(const String& name);
	Sample LoadSample(const String& name, const bool& external = false);
	shared_ptr<Graphics::Font> LoadFont(const String& name, const bool& external = false);
	...
	shared_ptr<Material> GetFontMaterial() const;
...
private:
	...
	Map<String, shared_ptr<Graphics::Font>> m_fonts;
	Map<String, Sample> m_samples;
	shared_ptr<Material> m_fontMaterial;
	shared_ptr<Material> m_fillMaterial;
